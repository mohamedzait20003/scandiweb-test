      ...
      <div className='h-full relative mx-auto px-6 flex flex-row items-center justify-between'>
        ...
        <div className='flex items-center gap-5 mr-8'>
          <div className='relative'>
            <button data-testid='cart-btn' className='h-10 min-w-[50px] bg-transparent flex items-center justify-center rounded-full text-2xl text-blue-950' onClick={handleCart}>
