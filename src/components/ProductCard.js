...
const ProductCard = ({ product }) => {
  const { Id, brand, description, gallery, inStock, name, price } = product;
    ...
    <div className={`w-full relative container p-4 hover:shadow-xl group cursor-pointer`} onClick={handleClick}>
      <div className='w-full flex flex-col items-center justify-center p-10'>
        ...
        <div className='w-full flex flex-row items-center justify-between'>
          ...
          {inStock && (
            <div className='flex justify-end items-center -top-96 w-10 h-10 opacity-0 group-hover:opacity-100'>
