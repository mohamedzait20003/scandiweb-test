        ...
        <div className='w-full flex flex-row items-center justify-between'>
          ...
          {inStock && (
            <div className='relative flex justify-end items-center -top-10 w-10 h-10 opacity-0 group-hover:opacity-100'>
              <button className='relative w-10 h-10 bg-green-400 flex justify-center items-center outline-none border-none rounded-full z-50' onClick={handleAdd} data-testid="cart-btn">
